class Admin::AnnouncementsController < AdminController
  ...
  before_action :set_announcement, only: [:show, :edit, :custom_edit, :update, :destroy, :announcementphoto_upload, :create_announcement_attachment]
  ...
  def announcement_params
    ...
    params.require(announcement_type.tableize.singularize).permit(:title, :subtitle, :article_id, :ranking, :js_context, :html_context , :attachment, :status )
  end
