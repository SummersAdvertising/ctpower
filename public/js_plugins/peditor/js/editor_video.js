editor.video = {
	initTab: function(){
		...
		var a = $("<a>").append("影片");
		var icon = $("<img>").attr("src", "/images/admin/film.png");
		a.prepend(icon);
	...
	initPost: function(){
		...
		var link = $("<input>");
		link.attr("id", "newVideoContent").attr("placeholder", "請輸入影片網址").attr("class", "text");
	...
	output: function(paragraph){
		var paragraphBox = $("<div class='video-container part'>"); //especially modified for ebs
